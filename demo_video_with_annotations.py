...
def main():
    ...
    # Iterate over all videos sequentially
...
if __name__ == '__main__':
    main()
# docker compose -f ./docker/docker-compose.yml exec hamer-dev python demo_video_with_annotations.py --in_dir "gcp_videos/Basic Pillow Strip" --out_dir gcp_videos/outputs/ --annot_dir gcp_videos/outputs/ --batch_size 32
